...
#     echo 'export PATH=$PATH:/home/vscode/.TinyTeX/bin/aarch64-linux' >> /home/vscode/.bashrc
#     export PATH=$PATH:/home/vscode/.TinyTeX/bin/aarch64-linux
    
#     # Uncomment the following lines if you need to install additional LaTeX packages
#     # tlmgr install fancyhdr fontawesome pgf lastpage synctex texcount latexindent titlesec nth gensymb
# fi